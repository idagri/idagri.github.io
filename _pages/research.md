...
<div class="pub-body">
<p class="pub-title">Agricultural Productivity and Urbanization: Evidence from Indonesia's Transmigration Program <span class="pub-flag">Job Market Paper</span> <a class="pub-btn" href="/files/Grigoryeva_JMP.pdf"><i class="fas fa-fw fa-file-pdf" aria-hidden="true"></i>PDF</a></p>
<p class="pub-meta">Solo-authored</p>
<p class="pub-status">Most recent draft linked above.</p>
