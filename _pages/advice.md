...
Resources I share with students and friends: how to find a predoc, tools I use for research, and notes on using AI well.

## Predoc & RA search

<details markdown="1">
<summary>Open predoc and RA resources</summary>

Here are some sources I've used and recommended for finding predoctoral and research-assistant (RA) positions. This list is not exhaustive, but it's a good place to start.
...
- The [World Bank](https://worldbankgroup.csod.com/ats/careersite) posts research positions (under the research & quantitative analysis job family); look for Research Assistant and ET Consultant roles
...
Code and how-to guides I've put together, mostly on my [GitHub](https://github.com/idagri):

- **[Stata tools and guides](https://github.com/idagri/stata-tools):** useful Stata tools with self-help guides, including making maps (SPMAP / GRMAP) and sample do-files.
- **[Digitizing historical maps with QGIS and Python](https://github.com/Xu-Haicheng/Digitizing-Historical-Maps-With-QGIS-and-Python):** a step-by-step guide to georeferencing and digitizing historical maps (co-authored with a lab student).

## AI tools

A few notes on using AI tools well for research and coding.

<!-- Replace the link below with the X/Twitter thread (or a hosted PDF of it). -->
*My thread on the AI tools I use is coming here.* In the meantime, find me on [X (@_idagri)](https://x.com/_idagri).
