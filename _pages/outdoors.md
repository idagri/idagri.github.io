...
.out-grid{ display:grid; grid-template-columns:repeat(auto-fill, minmax(165px,1fr)); gap:.6rem; margin:1.3rem 0 .5rem; }
...
@media (max-width:30em){ .out-grid{ grid-template-columns:1fr 1fr; gap:.45rem; } }
...
<!--
  ...
  and write a short label. Still available to add: first 100 km century ride, more skiing.
-->
